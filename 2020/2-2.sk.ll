...
WhileBegin:                                       ; preds = %"Invoke_Int#+_end72", %"Invoke_String#split_end"
  %i12 = load %Int*, %Int** %i
...
"Invoke_Array#length":                            ; preds = %WhileBegin
  ...
  %vtable_ref15 = load i8*, i8** %addr_vtable_ref14
  %vtable_ptr16 = bitcast i8* %vtable_ref15 to [21 x i8*]*
  %vtable17 = load [21 x i8*], [21 x i8*]* %vtable_ptr16
  %func_raw18 = extractvalue [21 x i8*] %vtable17, 16
...
WhileEnd:                                         ; preds = %"Invoke_Int#<_end"
  %as73 = bitcast %Day2* %self to %Object*
  %ans74 = load %Int*, %Int** %ans
...
"Invoke_Array#nth":                               ; preds = %WhileBody
  ...
  %vtable_ptr32 = bitcast i8* %vtable_ref31 to [21 x i8*]*
  %vtable33 = load [21 x i8*], [21 x i8*]* %vtable_ptr32
  %func_raw34 = extractvalue [21 x i8*] %vtable33, 19
...
"Invoke_Day2#_is_valid_end":                      ; preds = %"Invoke_Day2#_is_valid"
  ...
  br i1 %istrue46, label %IfThen, label %IfEnd
...
IfEnd:                                            ; preds = %"Invoke_Int#+_end", %"Invoke_Day2#_is_valid_end"
  %i59 = load %Int*, %Int** %i
  ...
  store i32 1, i32* %"addr_@llvm_int63"
  br label %"Invoke_Int#+64"
...
"Invoke_Int#+64":                                 ; preds = %IfEnd
  %addr_vtable_ref65 = getelementptr inbounds %Int, %Int* %i59, i32 0, i32 0
  %vtable_ref66 = load i8*, i8** %addr_vtable_ref65
  %vtable_ptr67 = bitcast i8* %vtable_ref66 to [32 x i8*]*
  %vtable68 = load [32 x i8*], [32 x i8*]* %vtable_ptr67
  %func_raw69 = extractvalue [32 x i8*] %vtable68, 14
  %func70 = bitcast i8* %func_raw69 to %Int* (%Int*, %Int*)*
  %result71 = call %Int* %func70(%Int* %i59, %Int* %sk_int61)
  br label %"Invoke_Int#+_end72"

"Invoke_Int#+_end72":                             ; preds = %"Invoke_Int#+64"
  store %Int* %result71, %Int** %i
  br label %WhileBegin

"Invoke_Object#putd":                             ; preds = %WhileEnd
  %addr_vtable_ref75 = getelementptr inbounds %Object, %Object* %as73, i32 0, i32 0
  %vtable_ref76 = load i8*, i8** %addr_vtable_ref75
  %vtable_ptr77 = bitcast i8* %vtable_ref76 to [10 x i8*]*
  %vtable78 = load [10 x i8*], [10 x i8*]* %vtable_ptr77
  %func_raw79 = extractvalue [10 x i8*] %vtable78, 6
  %func80 = bitcast i8* %func_raw79 to void (%Object*, %Int*)*
  call void %func80(%Object* %as73, %Int* %ans74)
  %"::Void" = load %Void*, %Void** @"::Void"
...
"Invoke_Array#nth":                               ; preds = %"Invoke_String#split_end"
  ...
  %func_raw13 = extractvalue [21 x i8*] %vtable12, 19
...
"Invoke_Array#nth41":                             ; preds = %"Invoke_String#split_end34"
  ...
  %vtable_ptr44 = bitcast i8* %vtable_ref43 to [21 x i8*]*
  %vtable45 = load [21 x i8*], [21 x i8*]* %vtable_ptr44
  %func_raw46 = extractvalue [21 x i8*] %vtable45, 19
...
"Invoke_Array#nth67":                             ; preds = %"Invoke_String#nth_byte_end"
  ...
  %vtable_ptr70 = bitcast i8* %vtable_ref69 to [21 x i8*]*
  %vtable71 = load [21 x i8*], [21 x i8*]* %vtable_ptr70
  %func_raw72 = extractvalue [21 x i8*] %vtable71, 19
...
"Invoke_Array#nth82":                             ; preds = %"Invoke_Array#nth_end75"
  ...
  %vtable_ptr85 = bitcast i8* %vtable_ref84 to [21 x i8*]*
  %vtable86 = load [21 x i8*], [21 x i8*]* %vtable_ptr85
  %func_raw87 = extractvalue [21 x i8*] %vtable86, 19
...
"Invoke_String#to_i_end":                         ; preds = %"Invoke_String#to_i"
  %mem98 = call i8* @GC_malloc(i64 ptrtoint (%Int* getelementptr (%Int, %Int* null, i32 1) to i64))
  %sk_int99 = bitcast i8* %mem98 to %Int*
  %addr_vtable100 = getelementptr inbounds %Int, %Int* %sk_int99, i32 0, i32 0
  store i8* bitcast ([32 x i8*]* @vtable_Int to i8*), i8** %addr_vtable100
  %"addr_@llvm_int101" = getelementptr inbounds %Int, %Int* %sk_int99, i32 0, i32 1
  store i32 1, i32* %"addr_@llvm_int101"
  br label %"Invoke_Int#-"

"Invoke_Int#-":                                   ; preds = %"Invoke_String#to_i_end"
  %addr_vtable_ref102 = getelementptr inbounds %Int, %Int* %result97, i32 0, i32 0
  %vtable_ref103 = load i8*, i8** %addr_vtable_ref102
  %vtable_ptr104 = bitcast i8* %vtable_ref103 to [32 x i8*]*
  %vtable105 = load [32 x i8*], [32 x i8*]* %vtable_ptr104
  %func_raw106 = extractvalue [32 x i8*] %vtable105, 15
  %func107 = bitcast i8* %func_raw106 to %Int* (%Int*, %Int*)*
  %result108 = call %Int* %func107(%Int* %result97, %Int* %sk_int99)
  br label %"Invoke_Int#-_end"

"Invoke_Int#-_end":                               ; preds = %"Invoke_Int#-"
  store %Int* %result108, %Int** %pos1
  %nums109 = load %Array*, %Array** %nums
  %mem110 = call i8* @GC_malloc(i64 ptrtoint (%Int* getelementptr (%Int, %Int* null, i32 1) to i64))
  %sk_int111 = bitcast i8* %mem110 to %Int*
  %addr_vtable112 = getelementptr inbounds %Int, %Int* %sk_int111, i32 0, i32 0
  store i8* bitcast ([32 x i8*]* @vtable_Int to i8*), i8** %addr_vtable112
  %"addr_@llvm_int113" = getelementptr inbounds %Int, %Int* %sk_int111, i32 0, i32 1
  store i32 1, i32* %"addr_@llvm_int113"
  %as114 = bitcast %Int* %sk_int111 to %Object*
  br label %"Invoke_Array#nth115"

"Invoke_Array#nth115":                            ; preds = %"Invoke_Int#-_end"
  %addr_vtable_ref116 = getelementptr inbounds %Array, %Array* %nums109, i32 0, i32 0
  %vtable_ref117 = load i8*, i8** %addr_vtable_ref116
  %vtable_ptr118 = bitcast i8* %vtable_ref117 to [21 x i8*]*
  %vtable119 = load [21 x i8*], [21 x i8*]* %vtable_ptr118
  %func_raw120 = extractvalue [21 x i8*] %vtable119, 19
  %func121 = bitcast i8* %func_raw120 to %String* (%Array*, %Object*)*
  %result122 = call %String* %func121(%Array* %nums109, %Object* %as114)
  br label %"Invoke_Array#nth_end123"

"Invoke_Array#nth_end123":                        ; preds = %"Invoke_Array#nth115"
  br label %"Invoke_String#to_i124"

"Invoke_String#to_i124":                          ; preds = %"Invoke_Array#nth_end123"
  %addr_vtable_ref125 = getelementptr inbounds %String, %String* %result122, i32 0, i32 0
  %vtable_ref126 = load i8*, i8** %addr_vtable_ref125
  %vtable_ptr127 = bitcast i8* %vtable_ref126 to [21 x i8*]*
  %vtable128 = load [21 x i8*], [21 x i8*]* %vtable_ptr127
  %func_raw129 = extractvalue [21 x i8*] %vtable128, 20
  %func130 = bitcast i8* %func_raw129 to %Int* (%String*)*
  %result131 = call %Int* %func130(%String* %result122)
  br label %"Invoke_String#to_i_end132"

"Invoke_String#to_i_end132":                      ; preds = %"Invoke_String#to_i124"
  %mem133 = call i8* @GC_malloc(i64 ptrtoint (%Int* getelementptr (%Int, %Int* null, i32 1) to i64))
  %sk_int134 = bitcast i8* %mem133 to %Int*
  %addr_vtable135 = getelementptr inbounds %Int, %Int* %sk_int134, i32 0, i32 0
  store i8* bitcast ([32 x i8*]* @vtable_Int to i8*), i8** %addr_vtable135
  %"addr_@llvm_int136" = getelementptr inbounds %Int, %Int* %sk_int134, i32 0, i32 1
  store i32 1, i32* %"addr_@llvm_int136"
  br label %"Invoke_Int#-137"

"Invoke_Int#-137":                                ; preds = %"Invoke_String#to_i_end132"
  %addr_vtable_ref138 = getelementptr inbounds %Int, %Int* %result131, i32 0, i32 0
  %vtable_ref139 = load i8*, i8** %addr_vtable_ref138
  %vtable_ptr140 = bitcast i8* %vtable_ref139 to [32 x i8*]*
  %vtable141 = load [32 x i8*], [32 x i8*]* %vtable_ptr140
  %func_raw142 = extractvalue [32 x i8*] %vtable141, 15
  %func143 = bitcast i8* %func_raw142 to %Int* (%Int*, %Int*)*
  %result144 = call %Int* %func143(%Int* %result131, %Int* %sk_int134)
  br label %"Invoke_Int#-_end145"

"Invoke_Int#-_end145":                            ; preds = %"Invoke_Int#-137"
  store %Int* %result144, %Int** %pos2
  %pass146 = load %String*, %String** %pass
  %pos1147 = load %Int*, %Int** %pos1
  br label %"Invoke_String#nth_byte148"

"Invoke_String#nth_byte148":                      ; preds = %"Invoke_Int#-_end145"
  ...
  %result155 = call %Int* %func154(%String* %pass146, %Int* %pos1147)
...
"Invoke_Int#==_end":                              ; preds = %"Invoke_Int#=="
  store %Bool* %result164, %Bool** %b1
  %pass165 = load %String*, %String** %pass
  %pos2166 = load %Int*, %Int** %pos2
  br label %"Invoke_String#nth_byte167"

"Invoke_String#nth_byte167":                      ; preds = %"Invoke_Int#==_end"
  %addr_vtable_ref168 = getelementptr inbounds %String, %String* %pass165, i32 0, i32 0
  %vtable_ref169 = load i8*, i8** %addr_vtable_ref168
  %vtable_ptr170 = bitcast i8* %vtable_ref169 to [21 x i8*]*
  %vtable171 = load [21 x i8*], [21 x i8*]* %vtable_ptr170
  %func_raw172 = extractvalue [21 x i8*] %vtable171, 15
  %func173 = bitcast i8* %func_raw172 to %Int* (%String*, %Int*)*
  %result174 = call %Int* %func173(%String* %pass165, %Int* %pos2166)
  br label %"Invoke_String#nth_byte_end175"

"Invoke_String#nth_byte_end175":                  ; preds = %"Invoke_String#nth_byte167"
  %char176 = load %Int*, %Int** %char
  br label %"Invoke_Int#==177"

"Invoke_Int#==177":                               ; preds = %"Invoke_String#nth_byte_end175"
  %addr_vtable_ref178 = getelementptr inbounds %Int, %Int* %result174, i32 0, i32 0
  %vtable_ref179 = load i8*, i8** %addr_vtable_ref178
  %vtable_ptr180 = bitcast i8* %vtable_ref179 to [32 x i8*]*
  %vtable181 = load [32 x i8*], [32 x i8*]* %vtable_ptr180
  %func_raw182 = extractvalue [32 x i8*] %vtable181, 21
  %func183 = bitcast i8* %func_raw182 to %Bool* (%Int*, %Int*)*
  %result184 = call %Bool* %func183(%Int* %result174, %Int* %char176)
  br label %"Invoke_Int#==_end185"

"Invoke_Int#==_end185":                           ; preds = %"Invoke_Int#==177"
  store %Bool* %result184, %Bool** %b2
  br label %OrBegin

OrBegin:                                          ; preds = %"Invoke_Int#==_end185"
  br label %AndBegin

OrElse:                                           ; preds = %AndEnd
  br label %AndBegin197

OrEnd:                                            ; preds = %AndEnd199, %AndEnd
  %OrResult = phi %Bool* [ %AndResult, %AndEnd ], [ %AndResult212, %AndEnd199 ]
  ret %Bool* %OrResult

AndBegin:                                         ; preds = %OrBegin
  %b1186 = load %Bool*, %Bool** %b1
  %"addr_@llvm_bool" = getelementptr inbounds %Bool, %Bool* %b1186, i32 0, i32 1
  %"@llvm_bool" = load i1, i1* %"addr_@llvm_bool"
  %istrue = icmp eq i1 %"@llvm_bool", true
  br i1 %istrue, label %AndMore, label %AndEnd

AndMore:                                          ; preds = %AndBegin
  %b2187 = load %Bool*, %Bool** %b2
  %"addr_@llvm_bool188" = getelementptr inbounds %Bool, %Bool* %b2187, i32 0, i32 1
  %"@llvm_bool189" = load i1, i1* %"addr_@llvm_bool188"
  %b2190 = sub i1 true, %"@llvm_bool189"
  %mem191 = call i8* @GC_malloc(i64 ptrtoint (%Bool* getelementptr (%Bool, %Bool* null, i32 1) to i64))
  %sk_bool = bitcast i8* %mem191 to %Bool*
  %addr_vtable192 = getelementptr inbounds %Bool, %Bool* %sk_bool, i32 0, i32 0
  store i8* bitcast ([10 x i8*]* @vtable_Bool to i8*), i8** %addr_vtable192
  %"addr_@llvm_bool193" = getelementptr inbounds %Bool, %Bool* %sk_bool, i32 0, i32 1
  store i1 %b2190, i1* %"addr_@llvm_bool193"
  br label %AndEnd

AndEnd:                                           ; preds = %AndMore, %AndBegin
  %AndResult = phi %Bool* [ %b1186, %AndBegin ], [ %sk_bool, %AndMore ]
  %"addr_@llvm_bool194" = getelementptr inbounds %Bool, %Bool* %AndResult, i32 0, i32 1
  %"@llvm_bool195" = load i1, i1* %"addr_@llvm_bool194"
  %istrue196 = icmp eq i1 %"@llvm_bool195", true
  br i1 %istrue196, label %OrEnd, label %OrElse

AndBegin197:                                      ; preds = %OrElse
  %b1200 = load %Bool*, %Bool** %b1
  %"addr_@llvm_bool201" = getelementptr inbounds %Bool, %Bool* %b1200, i32 0, i32 1
  %"@llvm_bool202" = load i1, i1* %"addr_@llvm_bool201"
  %b2203 = sub i1 true, %"@llvm_bool202"
  %mem204 = call i8* @GC_malloc(i64 ptrtoint (%Bool* getelementptr (%Bool, %Bool* null, i32 1) to i64))
  %sk_bool205 = bitcast i8* %mem204 to %Bool*
  %addr_vtable206 = getelementptr inbounds %Bool, %Bool* %sk_bool205, i32 0, i32 0
  store i8* bitcast ([10 x i8*]* @vtable_Bool to i8*), i8** %addr_vtable206
  %"addr_@llvm_bool207" = getelementptr inbounds %Bool, %Bool* %sk_bool205, i32 0, i32 1
  store i1 %b2203, i1* %"addr_@llvm_bool207"
  %"addr_@llvm_bool208" = getelementptr inbounds %Bool, %Bool* %sk_bool205, i32 0, i32 1
  %"@llvm_bool209" = load i1, i1* %"addr_@llvm_bool208"
  %istrue210 = icmp eq i1 %"@llvm_bool209", true
  br i1 %istrue210, label %AndMore198, label %AndEnd199

AndMore198:                                       ; preds = %AndBegin197
  %b2211 = load %Bool*, %Bool** %b2
  br label %AndEnd199

AndEnd199:                                        ; preds = %AndMore198, %AndBegin197
  %AndResult212 = phi %Bool* [ %sk_bool205, %AndBegin197 ], [ %b2211, %AndMore198 ]
  br label %OrEnd
}
